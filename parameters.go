...
func loadCmdParameters() {
	...
	flag.IntVar(&NumOfPackingServices, "p", 10, "NumOfPackingServices")
	...
	flag.BoolVar(&RSMResponsiveness, "r", false, "responsiveness")
